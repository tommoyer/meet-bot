...
CONFIG = {
    ...
    'google_impersonation_user': os.environ.get('GOOGLE_IMPERSONATION_USER'),
    'google_calendar_id': os.environ.get('GOOGLE_CALENDAR_ID', 'primary'),  # NEW: calendar id
...
class GoogleMeetService:
    ...
    def _create_calendar_event_with_meet(self, title: str, start_time: datetime, end_time: datetime) -> Optional[str]:
        ...
        try:
            ...
            calendar_id = CONFIG.get('google_calendar_id', 'primary')  # <-- use configurable calendar id
...
# The /meet-help endpoint is now obsolete and can be deleted if present.
